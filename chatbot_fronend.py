...
st.title("Hi, I'm AI Coach by Whizlabs 🦜🔗:sunglasses:") # **Modify this based on the title you want in want
#st.title("_Streamlit_ is :blue[cool] :sunglassess:")
...
input_text = st.chat_input("Powered by Whizlabs") # **display a chat input box
if input_text: 
